...
func (g *gormProvider) Create(ctx context.Context, model *entities.AddressCustomer) error {
...
func (g *gormProvider) Delete(ctx context.Context, id uuid.UUID) error {
	return errors.ErrSomethingWrong(g.logger, g.db.WithContext(ctx).Delete(&entities.AddressCustomer{}, "id = ?", id).Error)
}

// GetById implements Repository.
func (g *gormProvider) GetById(ctx context.Context, id uuid.UUID) (result models.SingleResult[*entities.AddressCustomer]) {
...
func (g *gormProvider) Update(ctx context.Context, model *entities.AddressCustomer) error {
